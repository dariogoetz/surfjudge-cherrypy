...
class TournamentManagerPlugin(plugins.SimplePlugin):
    ...
    def start(self):
        ...
        self.bus.subscribe(KEY_ENGINE_TM_SET_ADVANCING_SURFER, self.set_advancing_surfers)
    ...
    def stop(self):
        ...
        self.bus.unsubscribe(KEY_ENGINE_TM_SET_ADVANCING_SURFER, self.set_advancing_surfers)
        return
    ...
    def set_advancing_surfers(self, heat_id, surfer_id, color, advancing_from_heat_id, place):
        res = self.tournament_manager.get_advancing_surfers(heat_id, surfer_id, color, advancing_from_heat_id, place)
        return res
